...
using COREBlog.CORE.Entity.Enums; // Status Enum'ı içerisinden durumları almak için usinglere ekledik.
using System.Text;
...
namespace COREBlog.SERVICE.Base
{
    public class BaseService<T> : ICoreService<T> where T : CoreEntity
    {
        ...
        public T GetByID(Guid id)
        {
            ...
            // Bunlardan herhangi biri olabilir. O anda kullanılan entity type'ına göre ayarlaması için Set<T>() metodu kullanılabilir.
